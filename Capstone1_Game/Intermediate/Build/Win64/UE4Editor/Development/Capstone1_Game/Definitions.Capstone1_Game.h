...
#define UE_PROJECT_NAME Capstone1_Game
#define UE_TARGET_NAME Capstone1_GameEditor
#define UE_MODULE_NAME "Capstone1_Game"
...
#define CAPSTONE1_GAME_API DLLEXPORT
